...
import { RepositorioDespachosSql } from "./repositorios/despachos.repositorio.js";
...
const repositorioDespachos = new RepositorioDespachosSql(configuracion);
const aplicacion = crearAplicacion(configuracion, repositorio, repositorioSucursales, repositorioEnvios, repositorioDespachos);
