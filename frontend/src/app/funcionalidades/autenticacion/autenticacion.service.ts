...
export class AutenticacionService {
  ...
  public iniciarSesion(nombreUsuario: string, contrasena: string) { return this.http.post<RespuestaSesion>(`${environment.urlApi}/autenticacion/iniciar-sesion`, { nombreUsuario, contrasena }).pipe(tap(({ usuario }) => { limpiarFiltrosSesion(); this.filtrosGlobales.reiniciar(); this.usuario.set(usuario); })); }
